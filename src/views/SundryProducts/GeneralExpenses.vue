  ...
  methods: {
    fetchAllGeneralExpenses() {
      return new Promise((resolve, reject) => {
        fetch(
          "https://www.setrex.net/haircut/backend/public/api/term/" + localStorage.getItem("branch_id"),
          {
            method: "GET",
            headers: {
    ...
    deleteGeneralExpense(generalExpenseId) {
      fetch("https://www.setrex.net/haircut/backend/public/api/term/" + generalExpenseId, {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${localStorage.getItem("access_token")}`,
          "Content-Type": "application/json",
