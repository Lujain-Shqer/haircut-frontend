...
export default {
  ...
  mounted() {
    fetch(
      "https://www.setrex.net/haircut/backend/public/api/supplier/" + localStorage.getItem("branch_id"),
      {
        method: "GET",
        headers: {
    ...
    fetch(
      "https://www.setrex.net/haircut/backend/public/api/product/" + localStorage.getItem("branch_id"),
      {
        method: "GET",
        headers: {
          Authorization: `Bearer ${localStorage.getItem("access_token")}`,
